...
public class DistributionProtocol extends BaseEntity {
	...
	public boolean hasRequirement(String specimenType, String anatomicSite, Set<String> pathologyStatuses) {
		for (DpRequirement req : getRequirements()) {
			if (req.equalsSpecimenGroup(specimenType, anatomicSite, pathologyStatuses)) {
				return true;
			}
		}
